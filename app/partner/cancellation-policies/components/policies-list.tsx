...
interface PoliciesListProps {
  initialPolicies: CancellationPolicyDTO[];
}

export function PoliciesList({ initialPolicies }: PoliciesListProps) {
  const [selectedPolicy, setSelectedPolicy] = useState<CancellationPolicyDTO | null>(initialPolicies[0] || null);
