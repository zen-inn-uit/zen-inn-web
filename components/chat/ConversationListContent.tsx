...
export function ConversationListContent({ isDesktop = false }: ConversationListContentProps) {
  ...
  const selectedConversationId = pathname.includes('/messages/') 
    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 px-6">
        ...
        <p className="text-sm text-muted-foreground text-center max-w-sm leading-relaxed">
          Start chatting with hotels by visiting their detail pages and clicking the message button
        </p>
      </div>
    );
  }
